...
export default function ForgotPasswordPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      // requestPasswordReset always returns { ok: true } — we never reveal
      // whether the email is registered. Show the generic success view either way.
      await requestPasswordReset(email)
    } catch {
      // Swallow — show generic success to avoid leaking info.
    } finally {
      setSubmitting(false)
      setSubmitted(true)
    }
          ...
          {submitted ? (
            ...
            <div className="text-center py-2">
              ...
              <p className="text-sm text-gray-500 leading-relaxed mb-6">
                If that email exists in our system, we&apos;ll send password reset
