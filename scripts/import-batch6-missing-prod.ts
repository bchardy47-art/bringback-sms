/**
 * One-off, file-scoped import of ONLY the Batch 6 dealers missing from
 * production dealer_prospects.
 *
 * Scope guarantee: loads outputs/utah_dealer_prospects_batch_6_ALL20_IMPORT.csv,
 ...
 *   npx tsx scripts/import-batch6-missing-prod.ts
 * Run (commit):
 *   npx tsx scripts/import-batch6-missing-prod.ts --commit
 */
...
const CSV_PATH = 'outputs/utah_dealer_prospects_batch_6_ALL20_IMPORT.csv'
...
main().catch(err => {
  console.error('import-batch6-missing-prod failed:', err)
  process.exit(1)
})
